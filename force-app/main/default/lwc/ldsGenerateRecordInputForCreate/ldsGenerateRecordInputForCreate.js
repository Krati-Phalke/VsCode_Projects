...
import AREANUMBER_FIELD from '@salesforce/schema/Account.Area_Number__c';
...
export default class LdsGenerateRecordInputForCreate extends LightningElement {
    ...
    loadAccountCreateDefaults({ data, error }) {
        if (data) {
            ...
            this.recordInput = generateRecordInputForCreate(data.record, data.objectInfos[ACCOUNT_OBJECT.objectApiName]);
                 // Filters it to only createable fields
